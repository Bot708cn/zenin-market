    ...
    <div style={{ minHeight: "100vh", background: "#05070A", color: "#EAF1FF", fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 14 }}>Admin</span>
        </div>
        <button onClick={() => router.push("/")} style={{ background: "none", border: "1px solid #1C2436", borderRadius: 8, padding: "6px 10px", color: "#7C89A6", fontSize: 12, display: "flex", alignItems: "center", gap: 6 }}>
          <LogOut size={13} /> Boutique
        </button>
      </header>
